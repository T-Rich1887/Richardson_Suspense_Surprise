...
# list. Output is one cleaned file per season with goals and red cards in
# wide format.
#
...
def process_all_files(input_folder, output_folder):
    ...
    for input_file_path in league_files:
        ...
        try:
            ...
            output_filename = (
                os.path.basename(input_file_path).replace('.xlsx', '_goals_reds.xlsx')
            )
            processed_df_unique.to_excel(
